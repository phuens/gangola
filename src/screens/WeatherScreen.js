...
const openWeatherKey = '34afd3c47f0f706d32eb2bb013b4a58f';
        ...
        <View>
            ...
            >
                ...
                <View style={styles.current}>
                    ...
                    />
                    {/* <Text style={{ fontSize: 25 }}>{Math.round(forecast.current.temp)}°C</Text> */}
                </View>
                <Text style={styles.currentDescription}>{Math.round(forecast.current.temp)}°C</Text>
