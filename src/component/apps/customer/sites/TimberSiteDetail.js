...
import {timberSiteRegistration} from '../../../../redux/actions/siteActions';
import globalStyles from '../../../../styles/globalStyle';
import {getGPSLocation} from '../../../helper/Geolocation';
import SpinnerScreen from '../../../base/SpinnerScreen';

export const TimberSiteDetail = ({
  userState,
  commonState,
  navigation,
  timberSiteRegistration,
  handleError,
  getImages,
  setLoading,
}) => {
  ...
  const [transport_mode, settransport_mode] = useState('Self Owned Transport');
  ...
  const submitSiteInfo = async () => {
    ...
    timberSiteRegistration(site_info, images, isBuilding);
  };
  ...
  const addItemToList = () => {
    ...
    //   setErrorMsg('Select Source');
      ...
      setErrorMsg('Total requirement in cft is required');
    } else if (expected_quantity < 1) {
      setexpected_quantity('');
      setErrorMsg('Total requirement in cft cannot be zero');
    } else {
      setErrorMsg('');
      const item = {
        idx,
          ...
          <CardItem>
            ...
            {items.length==0 &&(
              <Button
                ...
                <Text>Add Expected Materials</Text>
              </Button>
            )}
            ...
            <Content style={globalStyles.content}>
              ...
              <View style={globalStyles.dropdown}>
                <Picker
                  ...
                  onValueChange={val => setproduct_category(product_category)}>
                  <Picker.Item
              ...
              <Item regular style={globalStyles.mb10}>
                <Input
                  ...
                  placeholder="Total requirement in cft"
